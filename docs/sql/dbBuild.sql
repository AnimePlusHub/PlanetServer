...
CREATE TABLE `friend` (
  ...
  INDEX `index_user_friend` (`user_id`, `friend_id`) USING BTREE,
  INDEX `index_user_group` (`user_id`, `group_id`) USING BTREE,
...
CREATE TABLE `friend_group` (
  ...
  UNIQUE INDEX `unique_user_group` (`user_id`, `group_name`) USING BTREE,
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`),
  INDEX `index_nick_name` (`nick_name`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
